defmodule Styx.SchemaRegistry.API do
  ...
  ```
    Styx.SchemaRegistry.API.config("http://localhost:8081")
  ```
  """
  ...
  List all subjects.
  ```
    Styx.SchemaRegistry.API.subjects("http://localhost:8081")
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.versions("http://localhost:8081", "value")
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.version("http://localhost:8081", "value", 1)
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.latest("http://localhost:8081", "value")
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.schema("http://localhost:8081", 1)
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.delete("http://localhost:8081", "value")
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.delete("http://localhost:8081", "value", 1)
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.register("http://localhost:8081", "value", %{"type" => "string"})
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.check("http://localhost:8081", "value", %{"type" => "string"})
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.test("http://localhost:8081", "value", %{"type" => "string"})
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.update_compatibility("http://localhost:8081", "NONE")
  ```
  """
  ...
  ```
    Styx.SchemaRegistry.API.update_compatibility("http://localhost:8081", "value", "NONE")
  ```
  """
