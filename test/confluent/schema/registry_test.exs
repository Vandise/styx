defmodule Styx.Confluent.Schema.RegistryTest do
  use ExUnit.Case
  doctest Styx.Confluent.Schema.Registry
  ...
  test "config", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.config("http://localhost:1111")
  ...
  test "subjects", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.subjects("http://localhost:1111")
  ...
  test "versions", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.versions("http://localhost:1111", "value")
    assert resp == [1]
  end
  ...
  test "version", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.version("http://localhost:1111", "value", 1)
  ...
  test "latest", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.latest("http://localhost:1111", "value")
    assert resp == %{"id" => 1, "version" => 1, "subject" => "value", "schema" => "\"string\""}
  end
  ...
  test "schema", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.schema("http://localhost:1111", 1)
    assert resp == %{"id" => 1, "version" => 1, "subject" => "value", "schema" => "\"string\""}
  end
  ...
  test "delete subject", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.delete("http://localhost:1111", "value")
    assert resp == [1, 2, 3]
  end
  ...
  test "delete version", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.delete("http://localhost:1111", "value", 1)
    assert resp == 1
  end
  ...
  test "register", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.register("http://localhost:1111", "value", %{"type" => "string"})
    assert resp == %{"id" => 1}
  end
  ...
  test "check", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.check("http://localhost:1111", "value", %{"type" => "string"})
  ...
  test "test", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.test("http://localhost:1111", "value", %{"type" => "string"})
  ...
  test "update subject compatibility", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.update_compatibility("http://localhost:1111", "NONE")
  ...
  test "update subject's version compatibility", %{bypass: bypass} do
    ...
    {:ok, resp} = Styx.Confluent.Schema.Registry.update_compatibility("http://localhost:1111", "value", "NONE")
    assert resp == %{"compatibility" => "NONE"}
  end
end